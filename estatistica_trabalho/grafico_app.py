"""
============================================================================
Atividade 02 — Simulação de Investimento em Bancos (Comparativo de gráficos)
============================================================================
...
try:
    ...
    """
    yf.download() baixa os dados do yfinance para utilizarmos no gráfico.
    """
    ...
    exit()
    """
    exit() encerra o programa imediatamente. Usamos isso para evitar que o código continue rodando com dados inválidos, o que causaria erros mais adiante. O usuário receberá uma mensagem clara sobre o que deu errado, em vez de um erro técnico confuso.
    """
...
for ativo in ativos:
    ...
    """
    add_trace() adiciona uma nova linha ao gráfico. Cada linha representa um banco diferente, mostrando como o investimento teria evoluído ao longo do tempo se tivesse sido investido apenas naquele banco.
    go.Scatter() é a class que define o tipo de gráfico (neste caso, uma linha). O parâmetro "y" recebe os valores do eixo vertical, "mode" define que queremos uma linha contínua, e "name" é o rótulo que aparecerá na legenda para identificar cada banco.
    """
...
"""
update_layout() define o título, rótulos dos eixos e o tema visual do gráfico.
"""
fig.update_layout(
